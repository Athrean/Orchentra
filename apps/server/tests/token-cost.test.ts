...
describe('estimateCostUsd', () => {
  ...
  it('calculates cost for openai/gpt-4o rates', () => {
  ...
  it('strips variant suffix for prefix match', () => {
    // ":beta" suffix should not change matched rates
  ...
  it('uses budget-tier rates for compact anthropic model id', () => {
  ...
  it('calculates cost for google/* flash model with fractional cents', () => {
  ...
  it('handles large token counts without precision loss', () => {
    // 10M input + 2M output at $3/$15 per M: 30 + 30 = $60
