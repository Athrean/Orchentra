...
// span. Supports backtick code, **bold**, *italic*, and _italic_. Nested or
// overlapping styles are treated as plain text — keeping this lossy is
// preferable to a half-correct full CommonMark parser.
