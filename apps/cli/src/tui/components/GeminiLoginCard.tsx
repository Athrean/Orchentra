...
import { loginGemini } from '@orchentra/cli-api'
...
export function GeminiLoginCard(props: GeminiLoginCardProps): React.ReactElement {
  ...
  useEffect(() => {
    ...
    void loginGemini({
      ...
      .then((r) => {
        ...
        finish({
          ok: true,
          message: `Connected to Gemini via Google${who} — run /model gemini-3.1-pro-preview to use it`,
          path: r.persistedPath,
        })
      })
      .catch((err: unknown) => {
