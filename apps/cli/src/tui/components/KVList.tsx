...
/**
 * Aligned key/value rows. Keys are rendered dim, right-padded to a fixed
 * width; values follow with optional colour. Inspired by the layout used by
 * `claude config` and friends.
 */
