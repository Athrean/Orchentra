...
// Code"); with two separate blocks the request succeeds. The string is the
// billing identifier Anthropic's edge inspects — DO NOT paraphrase or trim.
// Validated against live /v1/messages on 2026-04-30 — short prefix returned
// 200, drift returned 429 (single-block) or "OAuth not supported" (truncated).
